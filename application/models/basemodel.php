...
class BaseModel extends CI_Model
{
    ...
    */
    ...
    public function __construct()
    {
    	...
    	$this->load->database();
    	$this->load->library('phpfirebase');
    	
    	$this->phpfirebase->setBaseURI($this->config->item('firebase_baseuri'));
    	$this->phpfirebase->setToken($this->config->item('firebase_token'));
    ...
    protected function getCountRowValue($sql){
    ...
    public function hasColumnChanged($key){
    	if (in_array($key, $this->_changedColumns)) return true;
    	return false;
    }
    /**
